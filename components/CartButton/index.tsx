...
export function CartButton({ onClick }: CartButtonProps) {
  const { orderState, removeFromCart, clearCart } = useOrder()
  ...
  return (
    <Sheet>
      ...
      >
        <SheetHeader className="flex h-12 justify-center px-6 gap-0">
        ...
        {orderState.items.length > 0 && (
          <div className="border-t p-4 sm:p-6 dark:border-[#343434]">
              ...
              {appliedCoupon && (
                <div className="flex items-center justify-between text-muted-foreground">
                  <dt className="text-sm">
                    Desconto cupom ({appliedCoupon.discount}%)
                  </dt>
                  <dd className="text-sm font-medium text-green-500">
